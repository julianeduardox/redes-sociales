    ...
    <div class="legal-card">
      ...
      <div id="content-es">
        ...
        <div class="legal-section">
          ...
          <ul>
            <li><strong>Declaración de Uso de IA:</strong> XINDRO utiliza modelos fundacionales de Inteligencia Artificial generativa basados en procesamiento de lenguaje natural probabilístico (vía OpenRouter: Anthropic Claude, DeepSeek, OpenAI GPT, Meta Llama), así como motores heurísticos de clasificación de intenciones comerciales.</li>
        ...
        <div class="legal-section">
          ...
          <p>
            EL SERVICIO SE PROPORCIONA "TAL CUAL" Y "SEGÚN DISPONIBILIDAD", SIN GARANTÍAS DE NINGÚN TIPO, YA SEAN EXPRESAS, IMPLÍCITAS O LEGALES. XINDRO NO GARANTIZA QUE EL SERVICIO SEA ININTERRUMPIDO, LIBRE DE ERRORES, QUE LA IA LOGRE NIVELES ESPECÍFICOS DE VENTAS O ENGAGEMENT, NI QUE LAS APIS DE TERCEROS (META, OPENROUTER) MANTENGAN SU DISPONIBILIDAD PERMANENTE.
          </p>
        </div>
      ...
      <div id="content-en" style="display:none;">
        ...
        <div class="legal-section">
          ...
          <ul>
            <li><strong>AI Disclosures:</strong> XINDRO deploys generative natural language models (via OpenRouter: Anthropic Claude, DeepSeek, OpenAI GPT, Meta Llama) and heuristic intent classifiers.</li>
